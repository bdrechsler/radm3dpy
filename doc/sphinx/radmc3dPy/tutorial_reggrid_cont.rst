...
class in the following way. First we need to create an instance of this model class:::
...
be updated/overwritten. To prevent the update of the parameter file we pass the ``parfile_update=False`` keyword. Then we can use individual methods        
